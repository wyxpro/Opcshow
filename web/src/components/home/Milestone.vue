...
<template>
  ...
  >
    ...
    <!-- 标题头 -->
    <header :class="['page-header pointer-events-none absolute left-[42px] top-[34px] z-[100] transition-[transform,opacity] duration-500 ease-out', hintHidden ? 'translate-y-[-10px] scale-[0.92] opacity-40' : '']">
