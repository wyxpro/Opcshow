...
<template>
  ...
  >
    ...
    <div class="relative z-10 flex min-h-[100svh] flex-col justify-center px-10 py-24 md:px-20 md:py-28 lg:px-28">
      <div class="mx-auto w-full max-w-[1380px] text-center">
